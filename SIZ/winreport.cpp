...
void winReport::makeReport()
{
    ...
    QSqlQuery periodicTableQuery(" SELECT наименования.Наимен, наименование_по_нормам.Норма, наименования.Ед, наименования.Признак, наименования.Тип, работники.ТабНомер, работники.Цех, пункты_по_должностям.Должность, работники.Фамилия & ' ' & работники.Имя & ' ' & работники.Отчество AS ФИО, '0' AS Размер, '0' AS НГ, '0' AS ПЕ, выдано.ДатаВыдачи "
                                " FROM цех  "
    ...
    QSqlQuery onceGivenQuery(" SELECT TABLE1.Наимен, TABLE1.Норма, TABLE1.Ед, TABLE1.Признак, TABLE1.Тип, TABLE1.ТабНомер, TABLE1.Цех, TABLE1.Должность, TABLE1.ФИО, TABLE1.Размер, '0' AS НГ, '0' AS ПЕ, IIf(IsNull(TABLE2.ДатаВыдачи), 'Не выдано', TABLE2.ДатаВыдачи) AS дата_выдачи "
...
{
    int startCol = 14; //из файла excel
